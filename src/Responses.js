            ...
            <Grid.Column width="10">
              ...
              <Grid.Row>
                <Segment>
                  ...
                  <Item>
                    <Item.Content>
                      If You Only Read A Few Books In 2018, Read These<br/>
                      <span>Ryan Holiday</span>
                      </Item.Content>
                  <Item.Content style={{textAlign:'right'}}>
                        <svg width="20" height="20" viewBox="-5 -5 38 38">{clapButton}</svg> 54K  |  
              ...
              <Grid.Row>
                <Segment>
                  <Item.Group>
                    ...
                    <p>NEWSFLASH! White men are not the only people who write books. This list is almost completely white male authors, writing about white men. This list is a joke… consider reading books by people who don’t look like you and have different life experiences. It might not be such a bad thing to be “outwardly focused” once in a while.</p>
                    <Grid.Column>
                      <svg width="20" height="20" viewBox="-5 -5 38 38">{clapButton}</svg>54K<br/>
                      20 responses
                      <Icon name="bookmark outline" /><Icon name="angle down" />
                    </Grid.Column> 
                </Segment>
                <div style={{paddingBottom: '5px'}}></div>
              </Grid.Row>
